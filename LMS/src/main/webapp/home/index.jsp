	...
	<hr>
		...
		<div id = "links">	
			<ul>
				...
				<li>
					<img src = "/tomcatImg/books.png" style = "width:100px ; height:100px;" onclick = "location.href='../book/listBook.jsp'">
					<p>전체도서보기</p>
				</li>
				<li>
					<img src = "/tomcatImg/free-icon-faq-5623413.png" style = "width:100px ; height:100px;" onclick = "location.href='../ask/askHome.jsp'">
					<p>문의하기</p>
				</li>
			</ul>
		</div>
