...
<%
		...
		try{
			...
			if(rs.next()){
				...
				sql = "select b.b_code, b.b_image, b.b_name, b.b_author, b.b_date from book b join class cl on b.b_no= cl.b_no join report r on cl.b_no = r.b_no where cl.m_no =? and r.r_done = 'y'";	
				pstmt = conn.prepareStatement(sql);
				pstmt.setInt(1, m_no);
				rs=pstmt.executeQuery();
				if(rs.next()){
