...
%>
	...
	%>
		...
		<form name = "reportfrm" method = "post" action = "adminReportMark_ok.jsp">
		<textarea cols = "100" rows = "25" name = "r_content" id = "r_content" ><%=r_content%></textarea>
		<input type = "text" id = "reportByte"  class = "but"readonly>byte <input type = "button" value = "글자 수 출력" class = "but" onclick = "ChkByte()">
		<p><input type = "text" name = "r_score" class = "but" value = "<%=r_score%>">/100점
		<p>관리자 : <textarea cols = "50" rows = "10" name = "r_reply"><%=r_reply %></textarea>
		<p style = "font-family: 'Nanum Gothic', sans-serif;"><input type = "submit" value = "채점하기">
