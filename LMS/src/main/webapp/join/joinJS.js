	...
	function idcheck(){
		var idPop = window.open("idSearch.jsp", "pop", "width=600, height=600, top=0, left=0 resizable=yes");
	}
	...
	function findCom(){
		var pop = window.open("findCom.jsp", "pop","width=600, height=500,top=0,left=0,resizable=yes");	
	...
	function goBack(){
		var res = confirm("이 창을 벗어나면 입력하신정보가 사라집니다. 메인페이지로 넘어가시겠습니까?")
		if(res){
