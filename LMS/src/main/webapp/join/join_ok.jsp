...
<%
			...
			try{
				String sql = "INSERT INTO member(m_id, m_name, m_passwd, m_zipNo, m_addr, m_addrDetail, m_tel, m_phone, m_email, m_sendOk, m_dept, m_position, m_count, m_countY, m_countM, m_pass, c_code)";
					sql = sql+ " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
