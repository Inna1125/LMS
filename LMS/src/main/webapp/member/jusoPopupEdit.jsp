...
<% 
	...
	String m_addr = request.getParameter("roadAddrPart1"); 
	String m_zipNo = request.getParameter("zipNo"); 
	String m_addrDetail = request.getParameter("addrDetail"); 
...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIzMDExOTA5MzMwNjExMzQ0Mjg=";
	...
	if(inputYn != "Y"){
		...
		opener.jusoCallBack("<%=m_addr%>","<%=m_addrDetail%>","<%=m_zipNo%>");
		window.close();
		}
}
</script>
