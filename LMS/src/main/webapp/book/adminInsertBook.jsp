...
<body>
	<div class = "detail">
		<form method = "post" name = "bookfrm" action ="adminInsertBook_ok.jsp" enctype = "multipart/form-data">
		<fieldset>
			<table>
				<tr>
					<td class = "label">도서명</td>
					<td><input type = "text" name = "b_name" class = "inText"></td>
				</tr>
				<tr>
					<td class = "label">저자</td>
					<td><input type = "text" name = "b_author" class = "inText"></td>
				</tr>
				<tr>
					<td class = "label">출판사</td>
					<td><input type = "text" name = "b_pub" class = "inText"></td>
				</tr>
				<tr>
					<td class = "label">출판일</td>
					<td><input type = "text" name = "b_date" class = "inText" onchange = "setDate(this)"></td>
				</tr>
				<tr>
					<td class = "label">정상가격</td>
					<td><input type = "text" name = "b_price" class = "inText"></td>
				</tr>
				<tr>
					<td class = "label">페이지 수</td>
					<td><input type = "text" name = "b_pageNo" class = "inText"></td>
				</tr>
				<tr>
					<td class = "label">도서소개</td>
					<td><textarea rows="8" cols="30" name = "b_desc" class="texta" onchange="changeEduPurpose(this.value)"></textarea></td>
				</tr>
				<tr>
					<td class = "label">도서목차/내용</td>
					<td><textarea rows="8" cols="30" name = "b_index" class="texta"></textarea></td>
				</tr>
				<tr>
					<td class = "label">출판서평</td>
					<td><textarea rows="8" cols="30" name = "b_comment" class="texta"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style = "font-size:11pt;">대분류 <select name = "b_categoryF" onchange="firstChange()" size=1>
						<option value = ''>선택하세요</option>
						<option value = '3B'>소설</option>
						<option value = '3D'>시/에세이</option>
						<option value = '3I'>경제/경영</option>
						<option value = '3A'>자기계발</option>
						<option value = '3C'>인문</option>
						<option value = '3G'>역사/문화/과학</option>
						<option value = '3M'>종교</option>
						<option value = '3O'>정치/사회/문화</option>
						<option value = '3J'>컴퓨터/IT</option>
						<option value = '3N'>외국어</option>
						<option value = '3E'>가정/생활</option>
						<option value = '3F'>건강</option>
						<option value = '3L'>여행/기행</option>
						<option value = '3H'>취미/스포츠</option>
					</select>
				...
				<tr>
					...
					<td><textarea rows="8" cols="30" name = "b_purpose" class="texta"></textarea></td>
				</tr>
			</table>
			</fieldset>
			<p><input type = "button" class = "but" onclick = "goSave()" value = "등록하기">
		</form>
	</div>
</body>
</html>