...
<body>
	...
	<table>
		...
		try {
			sql = "select b_no, b_code, b_image, b_name, date_format(b_date,'%Y.%m.%d')as b_date, b_price, b_pub, date_format(b_regDate,'%Y.%m.%d')as b_regDate from book where " + method
	...
	<a href="memBookList.jsp" class="backList">목록가기</a>
	</div>
