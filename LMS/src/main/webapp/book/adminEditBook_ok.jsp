...
<body>
<%
		MultipartRequest multi = new MultipartRequest(request,"D:/JSP/LMS/src/main/webapp/images", 5*1024*1024, "utf-8", new DefaultFileRenamePolicy());
		...
		String b_old_image =multi.getParameter("b_old_image");
		...
		try{
			String sql = "update book set b_code =?, b_name =?, b_author =?, b_pub =?, b_date =?, b_price =?, b_pageNo =?, b_desc =?, b_index =?, b_comment =?, b_image =?, b_categoryF =?, b_categoryS =?, b_purpose =? where b_code =?";
			
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, b_code);
			pstmt.setString(2, b_name);
			pstmt.setString(3, b_author);
			pstmt.setString(4, b_pub);
			pstmt.setString(5, b_date);
			pstmt.setString(6, b_price);
			pstmt.setString(7, b_pageNo);
			pstmt.setString(8, b_desc);
			pstmt.setString(9, b_index);
			pstmt.setString(10, b_comment);
			pstmt.setString(11, b_image);
			pstmt.setString(12, b_categoryF);
			pstmt.setString(13, b_categoryS);
			pstmt.setString(14, b_purpose);
			pstmt.setString(15, b_code);
