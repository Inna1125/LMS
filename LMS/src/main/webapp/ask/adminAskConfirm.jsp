	...
	<div class = "askfrm">
		<fieldset class = "writefield">
			...
			<%
				...
				int i  = 1;
				try{
					String sql = "select a_no, a_category, a_title, a_date, ad_id from ask where a_repNo is null or a_no in (select a_no from ask where a_repNo is null and m_no is null) order by a_no desc";
		...
		%>
				<tr>
					...
					<td class = "list"><a href = "adminAskDetail.jsp?a_no=<%=a_no%>"><%=a_title%></a></td>
